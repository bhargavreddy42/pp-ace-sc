...
.method private final updateInsets()V
    ...
    .line 69
    invoke-virtual {v6}, Lcom/th3rdwave/safeareacontext/SafeAreaViewEdges;->getTop()Lcom/th3rdwave/safeareacontext/SafeAreaViewEdgeModes;

    move-result-object v0

    invoke-virtual {v11}, Lcom/th3rdwave/safeareacontext/EdgeInsets;->getTop()F

    move-result v2

    invoke-direct {p0, v0, v2, v1}, Lcom/th3rdwave/safeareacontext/SafeAreaViewShadowNode;->getEdgeValue(Lcom/th3rdwave/safeareacontext/SafeAreaViewEdgeModes;FF)F
    ...
    .line 70
    invoke-virtual {v6}, Lcom/th3rdwave/safeareacontext/SafeAreaViewEdges;->getRight()Lcom/th3rdwave/safeareacontext/SafeAreaViewEdgeModes;

    move-result-object v0

    invoke-virtual {v11}, Lcom/th3rdwave/safeareacontext/EdgeInsets;->getRight()F
    ...
    .line 71
    invoke-virtual {v6}, Lcom/th3rdwave/safeareacontext/SafeAreaViewEdges;->getBottom()Lcom/th3rdwave/safeareacontext/SafeAreaViewEdgeModes;

    move-result-object v0

    invoke-virtual {v11}, Lcom/th3rdwave/safeareacontext/EdgeInsets;->getBottom()F
    ...
    .line 72
    invoke-virtual {v6}, Lcom/th3rdwave/safeareacontext/SafeAreaViewEdges;->getLeft()Lcom/th3rdwave/safeareacontext/SafeAreaViewEdgeModes;

    move-result-object v0

    invoke-virtual {v11}, Lcom/th3rdwave/safeareacontext/EdgeInsets;->getLeft()F

    move-result v1

    invoke-direct {p0, v0, v1, v5}, Lcom/th3rdwave/safeareacontext/SafeAreaViewShadowNode;->getEdgeValue(Lcom/th3rdwave/safeareacontext/SafeAreaViewEdgeModes;FF)F
...
.method public onBeforeLayout(Lcom/facebook/react/uimanager/NativeViewHierarchyOptimizer;)V
    .locals 1
    .param p1    # Lcom/facebook/react/uimanager/NativeViewHierarchyOptimizer;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
