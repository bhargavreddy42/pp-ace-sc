.class public final Lcom/phonepe/network/external/rest/interceptors/ResponseEncryptionInterceptor;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/phonepe/network/external/rest/interceptors/ResponseEncryptionInterceptor;",
        ...
        "<init>",
        "(Lcom/google/gson/Gson;Lcom/phonepe/network/external/zlegacy/analytics/NetworkAnalyticMangerContract;)V",
...
# direct methods
.method public constructor <init>(Lcom/google/gson/Gson;Lcom/phonepe/network/external/zlegacy/analytics/NetworkAnalyticMangerContract;)V
    .locals 1
    ...
    iput-object p1, p0, Lcom/phonepe/network/external/rest/interceptors/ResponseEncryptionInterceptor;->gson:Lcom/google/gson/Gson;
...
.method public ppIntercept(Lokhttp3/Interceptor$Chain;)Lokhttp3/Response;
    ...
    .line 65
    sget-object v7, Lcom/phonepe/network/external/NetworkCommonConstantExternal;->UTF8:Ljava/nio/charset/Charset;
    ...
    .line 73
    :goto_2
    sget-object v6, Lcom/phonepe/network/external/rest/rsa/RSAKeyGenerator;->INSTANCE:Lcom/phonepe/network/external/rest/rsa/RSAKeyGenerator;

    invoke-virtual {v6}, Lcom/phonepe/network/external/rest/rsa/RSAKeyGenerator;->generateRSAKey()Lcom/phonepe/network/external/rest/rsa/KeyData;

    move-result-object v6

    .line 76
    new-instance v7, Lcom/phonepe/network/external/rest/rsa/RSAWrapper;

    invoke-virtual {v6}, Lcom/phonepe/network/external/rest/rsa/KeyData;->getPublicKey()Ljava/lang/String;

    move-result-object v8

    invoke-direct {v7, v8, v4}, Lcom/phonepe/network/external/rest/rsa/RSAWrapper;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_8
    iget-object v8, p0, Lcom/phonepe/network/external/rest/interceptors/ResponseEncryptionInterceptor;->gson:Lcom/google/gson/Gson;
    ...
    .line 99
    :cond_b
    invoke-virtual {v6}, Lcom/phonepe/network/external/rest/rsa/KeyData;->getPrivateKey()Ljava/security/PrivateKey;

    move-result-object v6

    invoke-static {v5, v6}, Lcom/phonepe/network/external/encryption/RequestEncryptionUtils;->decryptResponse(Ljava/lang/String;Ljava/security/PrivateKey;)Ljava/lang/String;
    ...
    .line 116
    invoke-virtual {p0, v5, v6, p1, v1}, Lcom/phonepe/network/external/rest/interceptors/BaseNetworkInterceptor;->setInterceptorLatency(JLjava/lang/String;Z)V
    :try_end_1
    ...
    .line 123
    invoke-direct {p0, p1}, Lcom/phonepe/network/external/rest/interceptors/ResponseEncryptionInterceptor;->sendAnalyticEvent(Ljava/lang/Exception;)V

    .line 124
    new-instance v0, Lcom/phonepe/network/external/rest/interceptors/exceptions/ResponseDecryptionException;

    invoke-virtual {p1}, Ljava/lang/Throwable;->getMessage()Ljava/lang/String;

    move-result-object p1

    invoke-direct {v0, p1}, Lcom/phonepe/network/external/rest/interceptors/exceptions/ResponseDecryptionException;-><init>(Ljava/lang/String;)V
